...
class ModelTest extends TestCase {
	...
	{
		$user = new User;
		$this->assertInstanceOf('Jferguson\EloquentCouchdb\Model', $user);
		$this->assertInstanceOf('Jferguson\EloquentCouchdb\Connection', $user->getConnection());
	...
	public function testFind()
	{
		...
		$this->assertInstanceOf('Jferguson\EloquentCouchdb\Model', $check);
		$this->assertEquals(true, $check->exists);
	...
	public function testGet()
	{
		...
		$this->assertInstanceOf('Jferguson\EloquentCouchdb\Model', $users[0]);
	}
	...
	{
	  //THese won't work since my query builder doesn't support where on anything but _id
	...
	public function testCreate()
	{
		...
		$check = User::where('_id', $user->getKey())->first();
		$this->assertEquals($user->getKey(), $check->getKey());
	...
	/**
	 * NOT IMPELEMENTED YET. May do some sort of auto copy of the field
	 * value into the _id value. Or something.
	 */
	...
	/**
	 * NOT IMPLEMENTED. Where clauses only work with _id at the moment.
	 */
	...
	public function testDates()
	{
		...
		$user = User::where('_id', $user->getKey())->first();
		$this->assertEquals('John Doe', $user->name);
	...
	/**
	 * Not sure what this is testing. But I don't support it.
	 */
	...
	/**
	 * No support at this time. Doable, though. So, maybe soon.
	 */
