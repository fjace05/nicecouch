...
abstract class Model extends \Jferguson\Eloquent\Model
{
    ...
    /**
     * Effectively removes the model from it's parent.
     */
    public function clearParentRelation(){
    ...
    /**
     *
     * This method must ensure that it is saving the embedded document properly.
     * It needs to find the root model (the doc that actually gets saved) and
     * set the embedded model on it.
     *
     * @param array $options
     * @return bool
     */
    protected function saveEmbedded($options = array()){
        $relation = $this->getParentRelation();

        //We will give embedded documents ids. BECAUSE WE CAN!
        ...
        //Update timestamps on this model if necessary.
        ...
        //This will iterate up the parent chain to saving changes all the way up to the root.
